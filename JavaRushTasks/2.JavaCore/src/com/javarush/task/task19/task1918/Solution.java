...
//            System.out.println(getTagElement(line, tagName));
//        }
//    }
//
//    private static String getTagElement(String s, String tagName) {
//        String result = "";
//        Pattern p = Pattern.compile("(<span>(.*?)</span>)|(<span(\\s\\w+?[^=]*?=\"[^\"]*?\")*>(</?(\\s|\\S)*?>)</span>)");
