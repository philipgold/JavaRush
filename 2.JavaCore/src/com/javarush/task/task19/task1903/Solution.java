...
public class Solution {
    ...
    public static void main(String[] args) {
        IncomeDataAdapter ida = new IncomeDataAdapter(new IncomeData() {
            @Override
    ...
    public static class IncomeDataAdapter implements Contact, Customer {
        ...
        public String getPhoneNumber() {
            ...
            sb.append("+")
                    ...
                    .append("(")
                    .append(fullNumber.substring(0, 3))
                    .append(")")
                    .append(fullNumber.substring(3, 6))
                    .append("-")
                    .append(fullNumber.substring(6, 8))
                    .append("-")
                    .append(fullNumber.substring(8, 10));
